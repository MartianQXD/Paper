...
\label{sec:ss}
In this section we formalise the BB84 Quantum Key Distribution Protocol. Our formalisation follows \cite{DF12}, where a manual analysis of the protocol is provided. Now we use our ground bisimulation checker to perform automatic analysis.
