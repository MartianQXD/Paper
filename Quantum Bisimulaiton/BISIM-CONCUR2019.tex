...
To show the above implementation is correct, we prove that $QSS$ is bisimilar to a swap operation between the first and the fouth qubits, that is $\mathcal{SWAP}_{1,4}[q_1,q_4]$. The specification can be written as follow:
\begin{flalign*}
