...
\end{flalign*}
We can find that the improved programs becomes bisimilar in the Table~\ref{tab:result}.
...
We see from the results of the Table~\ref{tab:result}, the programs are checked bisimilar with all the three different valuations of $q_1$.
...
From the results of the Table~\ref{tab:result},  we find that the programs are bisimilar with their specifications of all the three different valuations of $q_1$.
